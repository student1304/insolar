...
func (r *ContractConstructorHolder) AsChild(objRef core.RecordRef) (*Fabric, error) {
	ref, err := proxyctx.Current.SaveAsChild(objRef, *PrototypeReference, r.constructorName, r.argsSerialized)
	if err != nil {
		return nil, err
	}
	return &Fabric{Reference: ref}, nil
}

// AsDelegate saves object as delegate
func (r *ContractConstructorHolder) AsDelegate(objRef core.RecordRef) (*Fabric, error) {
...
func GetObject(ref core.RecordRef) (r *Fabric) {
	return &Fabric{Reference: ref}
}
...
func GetImplementationFrom(object core.RecordRef) (*Fabric, error) {
...
func (r *Fabric) GetReference() core.RecordRef {
	return r.Reference
}

// GetPrototype returns reference to the code
func (r *Fabric) GetPrototype() (core.RecordRef, error) {
...
func (r *Fabric) GetCode() (core.RecordRef, error) {
	if r.Code.IsEmpty() {
		ret := [2]interface{}{}
		var ret0 core.RecordRef
		ret[0] = &ret0
...
func (r *Fabric) Call(rootDomain core.RecordRef, method string, params []byte, seed []byte, sign []byte) (interface{}, error) {
...
func (r *Fabric) CallNoWait(rootDomain core.RecordRef, method string, params []byte, seed []byte, sign []byte) error {
	var args [5]interface{}
	args[0] = rootDomain
	args[1] = method
	args[2] = params
